FILES = build/kernel.asm.o build/kernel.o build/idt/idt.asm.o build/idt/idt.o build/memory/memory.o build/io/io.asm.o build/memory/heap/heap.o build/memory/heap/kheap.o build/memory/paging/paging.o build/memory/paging/paging.asm.o build/disk/disk.o build/string/string.o build/fs/pparser.o build/disk/streamer.o build/fs/file.o build/fs/fat/fat16.o build/gdt/gdt.asm.o build/gdt/gdt.o build/task/tss.asm.o build/task/task.o build/task/process.o build/task/task.asm.o build/isr80h/isr80h.o build/isr80h/misc.o build/isr80h/io.o build/keyboard/keyboard.o build/keyboard/classic.o build/loader/formats/elf.o build/loader/formats/elfloader.o build/isr80h/heap.o build/isr80h/process.o build/screen/screen.o build/time/timer.o
INCLUDES = -I src
...
all: bin/boot.bin bin/kernel.bin user_programs
	...
	sudo cp programs/echo/echo /mnt/d
	sudo umount /mnt/d
...
build/screen/screen.o: src/screen/screen.c
	i686-elf-gcc $(INCLUDES) -I src/screen $(FLAGS) -std=gnu99 -c src/screen/screen.c -o build/screen/screen.o


build/time/timer.o: src/time/timer.c
	i686-elf-gcc $(INCLUDES) -I src/time $(FLAGS) -std=gnu99 -c src/time/timer.c -o build/time/timer.o
